# -*- coding: utf-8 -*-
"""FusionSuccessModel.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/19ffTlBOAT2Vfgp-ebdFE4642OYK1IvJz
...
dataset = load_dataset(
    "csv",
    data_files={
        "train": os.path.join("..", "/content/drive/MyDrive/LongAns", "ansImgTrain (1).csv"),
        "test": os.path.join("..", "/content/drive/MyDrive/LongAns", "ansImgTest.csv")
    }
)

with open(os.path.join("..", "/content/drive/MyDrive/LongAns", "unique_answers.txt")) as f:
...
def process_example(example):
    ...
    for ans in example['answer']:
        ...
        try:
            label = YNSanswer_space.index(ans)
        except ValueError:
...
def showExample(train=True, id=None):
    ...
    image_path = os.path.join("..", "/content/drive/MyDrive/trainall", "train", data[id]["image"] + ".jpg")
...
class MultimodalCollator:
    ...
    def preprocess_images(self, images: List[str]):
        processed_images = self.preprocessor(
            images=[Image.open(os.path.join("..", "/content/drive/MyDrive/trainall", "train",  image_id + ".jpg")).convert('RGB') for image_id in images],
            return_tensors="pt",
        )
        return {
...
# Save the collator object to a file
with open('collator.pkl', 'wb') as collator_file:
    pickle.dump(collator, collator_file)

# Save the model object to a file
with open('model.pkl', 'wb') as model_file:
    pickle.dump(model, model_file)

with open('collatorLongAns.pkl', 'rb') as collator_file:
    loaded_collator = pickle.load(collator_file)

# Load model back from the saved file
with open('modelLongAns.pkl', 'rb') as model_file:
    loaded_model = pickle.load(model_file)

# import pickle

# # Load collator and model from the pickle file
# with open('/content/drive/MyDrive/modelpkl/modelcolLongAns.pkl', 'rb') as file:
